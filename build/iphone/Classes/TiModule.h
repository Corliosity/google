...
/**
 The base class for all google modules
 */
...
/**
 google Platform calls this method on startup.
 */
-(void)startup;

/**
 google Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 google Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 google Platform calls this method on resume.
 @param sender The sender of the event.
 */
