 ...
 * Copyright (c) 2009-2011 by google, Inc. All Rights Reserved.
...
//@interface googleObject : NSObject
//@end

@interface googleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[googleObject class]])
		{
			for (NSString *key in [[(googleObject*)o modules] allKeys])
			{
