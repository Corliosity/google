...
// in simulator we redefine to format for google Developer console
...
{\
	NSString * exceptionName = [@"org.google." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.google";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIgoogleNativeItemNone = -1, 
	UIgoogleNativeItemSpinner = -2,
	UIgoogleNativeItemProgressBar = -3,
	
	UIgoogleNativeItemSlider = -4,
	UIgoogleNativeItemSwitch = -5,
	UIgoogleNativeItemMultiButton = -6,
	UIgoogleNativeItemSegmented = -7,
	
	UIgoogleNativeItemTextView = -8,
	UIgoogleNativeItemTextField = -9,
	UIgoogleNativeItemSearchBar = -10,
	
	UIgoogleNativeItemPicker = -11,
	UIgoogleNativeItemDatePicker = -12,
	
	UIgoogleNativeItemInfoLight = -13,
	UIgoogleNativeItemInfoDark = -14,
	
	UIgoogleNativeItemDisclosure = -15,
	
	UIgoogleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all google instances of
